...
USAGE_STRING = "USAGE: python3 -m solutions_toolkit.uipath_block_scripts.workflow_upload <configuration_file>"
...
if __name__ == "__main__":
    ...
    pdf_filepaths = files_from_directory(config.invoice_input_dir, "*.pdf")
